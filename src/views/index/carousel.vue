<template>
    <div class="carousel"  >
        <div class="cover" :class="{'cover-title':coverShow}" :style="{'background-image':list[current]?`url(${list[current].imgUrl})`:false,'justify-content':list[current]?list[current].link:false}">
             <slot>
                ...
                <div class="carousel-item" :style="{'align-items':item.link}">
                    ...
                    <div class="content" v-html="item.remark"></div>
                </div>
            </transition>
