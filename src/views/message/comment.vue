           ...
           <Image
            ...
            class="user">
              ...
              <template #placeholder>
                <img style="width: 100%;height: 100%;" src="../../assets/logo.svg"/>
              </template><template #error>
                <img style="width: 100%;height: 100%;" src="../../assets/logo.svg"/>
              </template>
          </Image>
          <textarea ref="editor" v-model="content" class="editor" placeholder="Just Go Go."></textarea>
      </div>
      <div class="body">
          <div class="preview">
          ...
          <div>
            ...
            <button @click="submit" type="button" title="Cmd|Ctrl+Enter" class="submit">提交</button>
          </div>
      </div>
      <div class="footer">
